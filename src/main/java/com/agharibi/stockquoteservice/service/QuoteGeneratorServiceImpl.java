...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public QuoteGeneratorServiceImpl() {
        ...
        this.prices.add(new Quote("GOOG", 874.01));
        this.prices.add(new Quote("ORCL", 49.51));

        this.prices.add(new Quote("IBM", 159.52));
        this.prices.add(new Quote("INTC", 39.63));
        this.prices.add(new Quote("RHT", 84.20));
        this.prices.add(new Quote("VMW", 92.36));
    }
